...
| Forecast ตอน WAIT      | `src/components/app/CandleChart.tsx`                            | ซ่อน forecast เชิงทิศทางเมื่อ Final Signal เป็น WAIT และแสดงเฉพาะแท่งจริง/ข้อความงดทายเพื่อลดความสับสน                    |
