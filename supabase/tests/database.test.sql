...
SELECT throws_ok($$ SELECT * FROM public.market_price_samples $$, '42501', 'anon cannot select market samples');
SELECT throws_ok($$ SELECT * FROM public.market_candles $$, '42501', 'anon cannot select market candles');
