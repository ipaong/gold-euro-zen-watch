...
const SYSTEM = `คุณคือ "นักวิเคราะห์ผู้ช่วย" ของ Market Prediction Playground ซึ่งอธิบายผลวิเคราะห์ของสินทรัพย์ที่เลือกในกรอบเวลาที่ระบุ โดยข้อมูลตลาดอาจเป็น delayed และมาจาก Yahoo Finance ไม่ใช่ราคา execution ของโบรกเกอร์
